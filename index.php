...
<div id="left_pane" style="width: 290px;">
  <div style="z-index: 999999; position: relative; left: 10px; width: 100px;">

    <div id="by_county_content" style="display: none; margin-top: 130px;" class="content">
      <br>
        <div class="ui-widget">
  ...
  <div style="z-index: 1; position: relative; left: 10px; top: 10px">
    <div id="by_date_content" class="content" style="display: none;">
...
<div style="display: none; z-index: 999;" title="Choose Tmax Threshold" id="dialog_threshold">
  <p><b>Step 1</b>
    <br>
  ...
  var search_county_url = "search_county.php?county_input=" + county_input;
    $.ajax({
        ...
        'success': function (data) {
            ...
            map.fitBounds(searched.getBounds(), {padding: [250, 250]});
        }
    });
...
function heatwaveList(json_object) {
  ...
  else if (temps2014 == '' && stationData2014 == true) {
...
$('#county_input').keypress(function (e) {
 var key = e.which;
 if(key == 13)  // the enter key code
  {
    $('#search_county_button').click();
    return false;
  }
});
...
$('#left_pane').mouseenter(function() {
  map.dragging.disable();
});

$('#left_pane').mouseleave(function() {
  map.dragging.enable();
});
